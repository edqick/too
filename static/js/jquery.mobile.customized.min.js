		...
		function(a,b){
			...
			a.widget=function(b,c,d){
				...
				a.Widget.prototype={
					...
					_getCreateOptions:function(){var b={};
						if(a.metadata){
		...
		define(["jquery","./jquery.ui.widget"],function(a){
			(function(a,b){
				a.widget("mobile.widget",{_createWidget:function(){
					...
					this._trigger("init")},_getCreateOptions:function(){
				...
				a.mobile.media=function(){
					...
					return function(a){
						if(!(a in b)){
							...
							b[a]=c.css("position")==="absolute";e.add(f).remove()
						}
						return b[a]
					}
				}()
		...
		(function(a,b,c){
				...
				setup:function(){
					...
					d.bind(f,function(b){
						function j(b){
							...
							i={
								time:(new Date).getTime(),coords:[c.pageX,c.pageY]
							};
						...
						f={
							time:(new Date).getTime(),coords:[e.pageX,e.pageY],origin:a(b.target)
						},i;
			...
			(function(a,b){
				function j(){
					var a=e();
					if(a!==f){
						f=a;c.trigger("orientationchange")
					}
				}
